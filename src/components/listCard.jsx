...
export default function ListCard({ e , dbtype, handleClick }) {
    return (
        <section className="grid grid-cols-1 md:grid-cols-[20%_76%] lg:grid-cols-[10%_86%] my-4 bg-gray-50 p-8 lg:p-4 rounded-2xl shadow-md/70 shadow-gray-400 items-center justify-items-center-safe w-11/12 gap-10 mx-auto">
            <div className="bg-gray-200 rounded-2xl h-full md:h-3/4 my-auto flex items-center justify-center">
            ...
            <div className="w-full">
                ...
                <div className="flex items-center justify-between gap-4 font-semibold text-sm">
                    <span className="flex flex-wrap items-center gap-4 ">
                        ...
                        <button onClick={() => RemoveFromDB( dbtype, e.bookId, e.bookName, handleClick)} className="text-xl cursor-pointer font-semibold text-red-400"><RxCrossCircled /></button>
                </div>
            </div>
        </section>
    )
